...
},e.REGEXP_MODE,e.HASH_COMMENT_MODE,e.NUMBER_MODE]})})());hljs.registerLanguage("properties",(()=>{"use strict";return e=>{
...
},contains:[c]}]}}})());hljs.registerLanguage("x86asm",(()=>{"use strict";return s=>({
...
className:"meta",begin:/^\s*\.[\w_-]+/}]})})());hljs.registerLanguage("kotlin",(()=>{"use strict"
...
n.name="Arduino",n.aliases=["ino"],n.supersetOf="cpp",n}})());hljs.registerLanguage("julia",(()=>{"use strict";return e=>{
...
}],a.contains=n.contains,n}})());hljs.registerLanguage("plaintext",(()=>{"use strict";return t=>({
name:"Plain text",aliases:["text","txt"],disableAutodetect:!0})})());hljs.registerLanguage("latex",(()=>{"use strict";return e=>{const n=[{
...
},...B,...k,...S,I,K,...z,...q,U,G]}}})());hljs.registerLanguage("cmake",(()=>{"use strict";return e=>({name:"CMake",
...
className:"number",begin:"\\b\\d+",relevance:0},t]}}})());hljs.registerLanguage("objectivec",(()=>{"use strict";return e=>{
